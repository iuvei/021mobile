...
(function ($) {
    ...
    var scroller = (function () {
        ...
        scrollerCore.prototype = {
            ...
            refresh: false,
            refreshContent: "<div class='pullDown'><span class='pullDownIcon'></span><span class='pullDownLabel'>下拉刷新...</span></div>",
            ...
            coreAddPullToRefresh: function (rEl) {
                ...
                //Add the <div class='pullDown'><span class='pullDownIcon'></span><span class='pullDownLabel'>下拉刷新...</span></div> text.  Not optimal but keeps from others overwriting the content and worrying about italics
                //add the refresh div
                var afEl;
            ...
            fireRefreshRelease: function (triggered) {
                ...
                this.setRefreshContent("<div class='pullDown loading'><span class='pullDownIcon'></span><span class='pullDownLabel'>正在加载...</span></div>");
        ...
        nativeScroller.prototype.onTouchMove = function (e) {
            ...
            //check for cancel when refresh is running
                ...
                this.setRefreshContent("<div class='pullDown'><span class='pullDownIcon'></span><span class='pullDownLabel'>下拉刷新...</span></div>");
        ...
        nativeScroller.prototype.showRefresh = function () {
            if (!this.refreshTriggered) {
                ...
                this.setRefreshContent("<div class='pullDown flip'><span class='pullDownIcon'></span><span class='pullDownLabel'>松手开始更新...</span></div>");
        ...
        nativeScroller.prototype.onTouchEnd = function () {
            ...
            if (triggered&&this.refresh) {
                ...
                //iOS has a bug that it will jump when scrolling back up, so we add a fake element while we reset the <div class='pullDown'><span class='pullDownIcon'></span><span class='pullDownLabel'>下拉刷新...</span></div> position
        ...
        nativeScroller.prototype.hideRefresh = function (animate) {
            ...
            var endAnimationCb = function (canceled) {
                ...
                if (!canceled) { //not sure if this should be the correct logic....
                    ...
                    that.setRefreshContent("<div class='pullDown'><span class='pullDownIcon'></span><span class='pullDownLabel'>下拉刷新...</span></div>");
        ...
        jsScroller.prototype.onTouchMove = function (event) {
            ...
            //<div class='pullDown'><span class='pullDownIcon'></span><span class='pullDownLabel'>下拉刷新...</span></div> elastic
