...
function searchZhuihao(startDateTime, endDateTime, lotteryType) {
	page=0;
    var params = '{"InterfaceName":"GetChaseList","ProjectPublic_PlatformCode":2,"LotteryCode":' + lotteryType + ',"IsHistory":' + IsHistory + ',"statTime":"' + startDateTime + '","endTime":"' + endDateTime + '","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_ZH + '}';
