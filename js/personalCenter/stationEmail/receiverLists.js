...
function receiverLists_init() {
    ...
    var param = '{"ProjectPublic_PlatformCode":2,"InterfaceName":"GetSubUserName","UserID":'+ myUserID +'}';
...
//@ Subordinate
function getSubName(subData) {
    if (subData.SystemState == 64){
        var subArray = subData.UserModels;
