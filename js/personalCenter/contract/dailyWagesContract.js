...
function dailyWagesContract_scroll(QueryState) {
    ajaxUtil.ajaxByAsyncPost1(null, '{"InterfaceName":"GetDayWagesList","ProjectPublic_PlatformCode":2,"UserName":"","DayWagesState":'+ QueryState +',"UserType":0,"AgentLevel":0,"CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_dailyWagesCtt + '}', loaddailyWagesCtt_callBack, '正在加载数据...');
}
...
function loaddailyWagesCtt_callBack(data){
    ...
    var info = data.DayWagesListModels;
    ...
    $.ui.popup({
        ...
        doneCallback:
            function(){
                ...
                page = 0;
                QueryState = $("#dailyWagesQueryState").val();
                ajaxUtil.ajaxByAsyncPost1(null, '{"InterfaceName":"GetDayWagesList","ProjectPublic_PlatformCode":2,"UserName":"'+ searchUser +'","DayWagesState":'+ QueryState +',"UserType":0,"AgentLevel":0,"CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_dailyWagesCtt + '}', loaddailyWagesCtt_callBack, '正在加载数据...');
            },
        cancelOnly:false
    });
}
