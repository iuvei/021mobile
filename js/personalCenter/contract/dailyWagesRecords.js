...
function getdailyWagesRecords_scroll(startDateTime, endDateTime, IsSelf) {
    var param = '{"InterfaceName":"GetDayWagesRecordsList","ProjectPublic_PlatformCode":2,"IsSelf":'+IsSelf+',"BeginTime":"' + startDateTime + '","EndTime":"' + endDateTime + '","UserID":"'+ myUserID +'","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_dailyWagesRecord + '}';
    ...
    $.ui.popup({
        ...
        doneCallback:
            function() {
                ...
                page = 0;
                IsSelf = $("#dailyWagesRecordType").val();
                var param = '{"InterfaceName":"GetDayWagesRecordsList","ProjectPublic_PlatformCode":2,"User_Name":"' + searchUser + '","BeginTime":"' + startDateTime + '","EndTime":"' + endDateTime + '","IsSelf":' + IsSelf + ',"CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_dailyWagesRecord + '}';
                ajaxUtil.ajaxByAsyncPost1(null, param, getdailyWagesRecord_callBack, null);
            },
        cancelOnly:false
    });
