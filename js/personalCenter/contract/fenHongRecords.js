...
function getFenHongRecords_scroll(startDateTime, endDateTime, IsSelf) {
    var param = '{"InterfaceName":"GetDividentsList","ProjectPublic_PlatformCode":2,"IsSelf":'+IsSelf+',"BeginTime":"' + startDateTime + '","EndTime":"' + endDateTime + '","UserID":"'+myUserID+'","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_FenHongRecord + '}';
...
function getfenHongRecord_callBack(data){
    ...
    var info = data.DividentsDetailAllList;
    ...
    $.ui.popup({
        ...
        doneCallback:
            function() {
                ...
                page = 0;
                IsSelf = $("#fenHongRecordType").val();
                var param = '{"InterfaceName":"GetDividentsList","ProjectPublic_PlatformCode":2,"UserName":"' + searchUser + '","BeginTime":"' + startDateTime + '","EndTime":"' + endDateTime + '","IsSelf":' + IsSelf + ',"CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_FenHongRecord + '}';
                ajaxUtil.ajaxByAsyncPost1(null, param, getfenHongRecord_callBack, null);
            },
        cancelOnly:false
    });
