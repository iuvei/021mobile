...
function searchteamWithdrawal(startDateTime, endDateTime, type) {
    page=0;
    ajaxUtil.ajaxByAsyncPost(null, '{"InterfaceName":"GetUserDrawingsInfoByPage","SearchMyTeam":true,"ProjectPublic_PlatformCode":3,"DrawingsState":' + type + ',"BeginDate":"' + startDateTime + '","EndDate":"' + endDateTime + '","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_teamWithdrawal + '}', 
...
function queryteamWithdrawalUserName(searchUser){
    page = 0;
    ajaxUtil.ajaxByAsyncPost(null, '{"LikeUserName":"'+searchUser+'","InterfaceName":"GetUserDrawingsInfoByPage","SearchMyTeam":true,"ProjectPublic_PlatformCode":3,"DrawingsState":' + type + ',"BeginDate":"' + startDateTime + '","EndDate":"' + endDateTime + '","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_teamWithdrawal + '}', 
    teamWithdrawal_searchSuccessCallBack, '正在加载数据...');
}