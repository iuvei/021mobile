...
function searchTeamCharge_Record(startDateTime, endDateTime, type) {
    ajaxUtil.ajaxByAsyncPost(null, '{"InterfaceName":"GetUserRechargeInfoByPage","SearchMyTeam":true,"ProjectPublic_PlatformCode":2,"RechargeState":' + type + ',"BeginDate":"' + startDateTime + '","EndDate":"' + endDateTime + '","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_teamCharge + '}',
...
function queryTeamChargeUserName(searchUser){
    page = 0;
    ajaxUtil.ajaxByAsyncPost(null, '{"LikeUserName":"'+searchUser+'","InterfaceName":"GetUserRechargeInfoByPage","SearchMyTeam":true,"ProjectPublic_PlatformCode":2,"RechargeState":' + type + ',"BeginDate":"' + startDateTime + '","EndDate":"' + endDateTime + '","CurrentPageIndex":' + page + ',"CurrentPageSize":' + PAGESIZE_teamCharge + '}',
        TeamCharge_searchSuccessCallBack, '正在加载数据...');
}