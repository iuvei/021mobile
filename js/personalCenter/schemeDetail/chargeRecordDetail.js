...
function chargeRecordDetailInit(){
	...
	var $account=$('<li>订单号：<span>'+chargeItem.orderId+'</span></li><li>账户：<span>'+chargeItem.accountnum+'</span></li>' +
		'<li>充值金额：<span>'+chargeItem.tmoney+' 元</span></li><li>充值方式：<span>'+chargeItem.payType+'</span></li><li>充值状态：<span>'+chargeItem.state+'</span></li><li>交易时间：<span>'+chargeItem.optime+'</span></li><li>备注：<span>'+chargeItem.details+'</span></li>');
