...
function bettingDetilInit(){
    ...
    var param ='{"ProjectPublic_PlatformCode":2,"InterfaceName":"GetBetDetailNew","LotteryCode":"' + lotteryId + '","IsHistory":' + IsHistory + ',"OrderID":"' + liuShuiId + '"}';
    ajaxUtil.ajaxByAsyncPost(null, param, function(data){
        var betDetailInfo = data.UserBetInfo.Bet[0];
